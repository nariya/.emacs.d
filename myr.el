...
(add-to-list 'load-path "~/Documents/github/boo-mode/")

(require 'auto-install)

;for command and option key change
...
(setq user-full-name "Nariya Takemura")
...
(setq mew-imap-user "takemura@platinum-egg.com")
...
(setq mew-smtp-user "takemura@platinum-egg.com")
(setq mew-smtp-server "smtp.gmail.com")
...
;platform依存の分岐がかけるようになる.
(require 'platform-p)


;(when platform-darwin-p  ; 以後、OSX固有の機能の記述
;   ;; Meta -> Command これはうれしい.
;   (setq ns-command-modifier (quote meta)) 
;   (setq ns-alternate-modifier (quote super))
;   )
